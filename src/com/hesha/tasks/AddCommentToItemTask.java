...
public class AddCommentToItemTask extends AsyncTask<Void, Void, Void> implements Constants{
	private static final String TAG = "AddCommentToItemTask";
	private Context context;
	private ProgressDialog dialog;
	String response;
	private AddCommentToItemPar parameter;
	private OnTaskFinishedListener listener;
	public AddCommentToItemTask(Context context, ProgressDialog dialog, AddCommentToItemPar parameter) {
	...
	protected Void doInBackground(Void... params) {
		...
		String url = SERVER_URL + "?ac=addCommentToItem";
